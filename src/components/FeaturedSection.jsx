...
export default function FeaturedSection() {
    ...
    const handleScrollRight = () => {
        scrollContainerRef.current.scrollBy({ left: 300, behavior: 'smooth' }); // scrolls to 500px down
    };
    const handleScrollLeft = () => {
        scrollContainerRef.current.scrollBy({ left: -300, behavior: 'smooth' }); // scrolls to 500px down
    };
    return (
        <div className="w-full h-auto bg-gray-300 p-10 flex flex-col gap-5 lg:p-20 lg:gap-10">
            ...
            <div ref={scrollContainerRef} className="w-full h-[400px] bg-gray-300 rounded-[7px] flex overflow-x-auto space-x-4 scrollbar-hide">
