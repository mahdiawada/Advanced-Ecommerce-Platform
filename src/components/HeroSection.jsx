...
export default function HeroSection() {
     ...
     return (
        <div className='w-full h-[auto] flex flex-col gap-7 box-border p-3.5 pt-10 
                         md:p-12 lg:flex-row lg:p-16 xl:p-30 content-around bg-gray-100'>
              ...
              <div className='pic-div lg:w-1/2'>
                <img className='rounded-2xl mt-5 shadow-[0_35px_35px_rgba(0,0,0,0.25)] hover:shadow-[0_35px_35px_rgba(0,0,0,0.4)] duration-300
